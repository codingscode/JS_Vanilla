...
var resultado_11 = String.fromCharCode(102)
var resultado_12 = String.fromCharCode(103)
var resultado_13 = String.fromCharCode(111)
var resultado_14 = String.fromCharCode(119)
var resultado_15 = String.fromCharCode(120)
var resultado_16 = String.fromCharCode(140)
var resultado_17 = String.fromCharCode(142)



console.log(`${resultado_01} || ${resultado_02} || ${resultado_03} || ${resultado_04} 
            || ${resultado_05} || ${resultado_06} || ${resultado_07} || ${resultado_08} 
            || ${resultado_09} || ${resultado_10} || ${resultado_11} || ${resultado_12} 
            || ${resultado_13} || ${resultado_14} || ${resultado_15} || ${resultado_16} 
            || ${resultado_17}  `)
